...
import contractABI from '../../hardhat/src/artifacts/contracts/WavePortal.sol/WavePortal.json'


const CONT_ADD = `0x073fc600f2f263c431f3C5e11c1B01437AF2855b`
...
export const useCryptoStore = defineStore('crypto', () => {
  ...
  async function getBalance() {
    ...
    try {
      ...
      if (ethereum) {
        ...
        const wavePortalContract = new ethers.Contract(CONT_ADD, contractABI.abi, signer)
  ...
  async function wave(messageInput: any) {
